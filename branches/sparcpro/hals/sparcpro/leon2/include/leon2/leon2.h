/*
    ...
    found in the development root of ERCOS-RT on LEON2.
*/
...
/** LEON2 typically takes 3us to start/stop the timer  */
#define LEON2_AVG_TIMER_OVERHEAD  3

/**
 * Timer Counter value. The timer counter in LEON2 is a 24 bit timer counter
 */
#define LEON2_TIMER_COUNTER TIME_PIT_PERIOD//0x00FFFFFFULL
...
#define TARGET_Clear_interrupt( _vector ) \
    do { \
        _sparcpro_disable_irq(); \
        REGMAP.irq_clear = (1 << (_vector & 0xf)); \
        _sparcpro_enable_irq(); \
    } while (0)
