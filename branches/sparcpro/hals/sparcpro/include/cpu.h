...
/**
 *  \brief This function initialises the context of a given task.
 *
 *  \param  the_context This input parameter specifies the hardware context of
 *  the task. This hardware context will be (re)-stored every time a context
 *  switch is performed
 *  \param  stack_base  This input parameter contains the stack base
 *  \param  size        This input parameter contains the size of the stack
 *  associated with the task
 *  \param  level       This input parameter specifies the register window set
 *  leve associated to the task. There are several sets of register windows that
 *  can be defined during configuration. When more than 1 sets are defined,
 *  those are reserved to the task(s) with level 0, 1, 2, ..., respectively
 *  \param  entry_point This input parameter specifies the entry point of the
 ...
 */
void sparcpro_init(void);

//void clear_bss(void);

extern void _sparcpro_disable_irq();
extern void _sparcpro_enable_irq();
