...
/** Register window set level   */
#define REGW_LVL_OFFSET   0x88
/** Padding to make it multiple of 64 bits  */
#define DUMMY_OFFSET   0x8c

/**  Context control size    */
#define CONTEXT_CONTROL_SIZE 0x90
...
#define SET_REGWIN_LEVEL(level) \
    set level, %g2; \
    set REGMAP, %g3; \
    st %g2, [%g3 + REGMAP_REGWIN_SET_CTRL]; \

#define CLR_REGWIN_LEVEL \
    set REGMAP, %g3; \
    clr [%g3 + REGMAP_REGWIN_SET_CTRL]; \
