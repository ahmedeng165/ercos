...
#include <arch.h>
#include <leon3/timer.h>
#include <leon3/serial.h>
#include <leon3/leon3.h>
...
typedef sparcpro_context_t ercos_hal_hwcontext_t;
...
static inline void ercos_hal_hwcontext_init(ercos_hal_hwcontext_t * ctx,
	...
	sparcpro_context_init(ctx, (uint8_t *)stackbase, stacksize, level, entry);
}
