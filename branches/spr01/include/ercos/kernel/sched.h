...
#ifndef _ERCOS_KERNEL_SCHED_H_
#define _ERCOS_KERNEL_SCHED_H_

#include <ercos/kernel/types.h>
#include <ercos/config.h>

/** The maximum priority of a task */
#define SCHED_MAX_PRIORITY 0

/** The minimum priority of a task */
#define SCHED_MIN_PRIORITY (CONFIG_ERCOS_MAX_PRIO - 1)
