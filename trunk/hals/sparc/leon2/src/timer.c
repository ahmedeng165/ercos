...
void CPU_TimerInit(void)
{
    ...
    REGMAP.timer_1_counter = TIME_PIT_PERIOD;        /*  RTCC    */
    REGMAP.timer_1_reload = TIME_PIT_PERIOD; //LEON2_TIMER_COUNTER;

    REGMAP.prescaler_counter  = CONFIG_CLOCK_SPEED_MHZ - 1;  /*  RTCS  */
    REGMAP.prescaler_reload  = CONFIG_CLOCK_SPEED_MHZ - 1;  /*  RTCS  */
 ...
 */
void CPU_ClockInit(uint32_t _ticks)
{
